...
exports.levelSequences = {
  education: [
    require('./education/cherry-pick').level,
    require('./education/reverseChanges').level
  ],
  // intro: [
...
var sequenceInfo = exports.sequenceInfo = {
  education: {
    displayName: {
      'de_DE': 'Weiterbildung Git'
    },
    about: {
      'de_DE': 'Diese Level sollen dir helfen Git besser zu verstehen.'
    },
  },
  // intro: {
  //   displayName: {
